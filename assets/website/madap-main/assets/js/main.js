            ...
            $.ajax({
                ...
                success: function(response) {                    
                    ...
                    try {
                        ...
                        if (obj.status == 'success') {
                            ...
                            input.each(function() {
                                ...
                                if(obj.fields[input_name] == true) {
                                    $(ID+' .field-'+input_name).removeClass('invalid').addClass('invalid'); 
                                } else { 
                        ...
                        btn.removeClass('effect-motion-bg');
                        input.val('').removeClass('invalid').removeClass('valid');
                        alert.text('Sua mensagem foi enviada.').removeClass('valid').addClass('invalid').fadeIn();
                    }
                }
            })
        })
...
jQuery(function ($) {
    ...
    if(cookieNotice) {
        ...
        gdprCookieNoticeLocales.en = {
            description: 'Usamos cookies para oferecer uma melhor experiência de navegação, personalizar conteúdo e anúncios, fornecer recursos de mídia social e analisar nosso tráfego. Leia sobre como usamos cookies e como você pode controlá-los clicando em Configurações de Cookies. Você concorda com nossos cookies se continuar a usar este site.',
            ...
            cookie_essential_desc: 'Os cookies necessários ajudam a tornar um site utilizável, permitindo funções básicas, como navegação na página e acesso a áreas seguras do site. O site não pode funcionar corretamente sem esses cookies.',
            ...
            cookie_analytics_desc: 'Usamos cookies analíticos para nos ajudar a medir como os usuários interagem com o conteúdo do site, o que nos ajuda a personalizar nossos sites e aplicativos para você, a fim de aprimorar sua experiência.',
            cookie_marketing_title: 'Cookies de Marketing',
            cookie_marketing_desc: 'Esses cookies são usados ​​para tornar as mensagens publicitárias mais relevantes para você e seus interesses. A intenção é exibir anúncios relevantes e atraentes para o usuário individual e, portanto, mais valiosos para editores e anunciantes terceirizados.'
        }

        gdprCookieNotice({
            locale: 'pt', // This is the default value
            ...
            statement: 'https://ehancy.com', // Link to your cookie statement page
